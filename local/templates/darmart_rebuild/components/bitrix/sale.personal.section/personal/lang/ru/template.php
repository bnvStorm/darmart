...
$MESS["SPS_PERSONAL_PAGE_NAME"] = "Основные данные";
...
$MESS["TITLE_MAIN"] = "Моя учетная запись";
$MESS["TITLE_ORDERS"] = "Мои заказы";
$MESS['TITLE_SUBSCRIBE'] = 'Подписка';
$MESS["FAVORITES_PAGE"] = "Изменить закладки";
$MESS["CHANGE_PASSWORD_PAGE"] = "Смена пароля";
