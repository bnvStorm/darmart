<?php
$MESS['PAGE_TITLE'] = 'Registration';
$MESS['AUTH_MESS'] = 'If you are already registered go to <a href="https://darmart.kz/login/">authentication page</a>.';
$MESS['MAIN_DATA_TITLE'] = 'Main data';
$MESS['ADDRESS_DATA_TITLE'] = 'Your address';
$MESS['PASSWORD_TITLE'] = 'Your password';
$MESS['NEWS_TITLE'] = 'Subscribe news';

$MESS['COUNTRY_KAZAKHSTAN'] = 'Kazakhstan';

$MESS['SELECT_CHOOSE'] = '--- Choose ---';
$MESS['SUBSCRIBE'] = 'Subscribe';

$MESS['YES'] = 'Yes';
$MESS['NO'] = 'No';

$MESS['REGISTERED'] = 'You are already registered';
