...
?>
    <div class="bx-catalog-element bx-<?= $arParams['TEMPLATE_THEME'] ?>" id="<?= $itemIds['ID'] ?>"
        ...
        <div class="container-fluid">
            <input type="hidden" id="<?= $itemIds['TREE_ID'] ?>">
            <input type="hidden" id="<?= $itemIds['DISPLAY_MAIN_PROP_DIV'] ?>">
            <input type="hidden" id="<?= $itemIds['OLD_PRICE_ID'] ?>">
            <div class="card">


                <div class="row">
                    <div id="content" class="col-md-7 col-sm-7 thumbnail product-item-detail-main">
                        <div class="product-item-detail-slider-container" id="<?= $itemIds['BIG_SLIDER_ID'] ?>">
                            <span class="product-item-detail-slider-close" data-entity="close-popup"></span>
                            <div style="width:100%;" class="product-item-detail-slider-block
                                ...
                                <div class="product-info">
                                    ...
                                    <div class="product-item-detail-info-container">
                                        ...
                                        <dl class="product-item-detail-properties">
                                            ...
                                            <dt><?= Loc::getMessage('CATALOG_QUANTITY') ?></dt>
                                            <dd>
                                        ...
                                        <div class="detail-action">
                                            ...
                                            <div id="<?= $itemIds['BASKET_ACTIONS_ID'] ?>"
                                                ...
                                                if ($showBuyBtn) {
                                                    ...
                                                    <!--                                                        product-item-detail-buy-button--><?//=$buyButtonClassName
                                                    ?>
                                                    <a class="btn main-btn " id="<?= $itemIds['BUY_LINK'] ?>"
                                                       href="javascript:void(0);">
