...
<div id="content" class="col-sm-12">
    <div class="card">
        <h1 class="title-page"><?= GetMessage("M_COMPARE") ?></h1>
    <?
	if ($isAjax)
	{
	...
	?>
	<div style="display:none;" class="mb-3 d-flex align-items-center">
		<div class="pr-2">
	...
	{
		?>
		<div style="display:none;" class="catalog-compare-filter p-3 mb-3">
			...
			<tr>
				...
				<?foreach($arResult["ITEMS"] as $arElement)
				{
					...
					<td>
                        ...
                        <?endif;?>
						<a class="btn" onclick="CatalogCompareObj.delete('<?=CUtil::JSEscape($arElement['~DELETE_URL'])?>');" href="javascript:void(0)"><?=GetMessage("CATALOG_REMOVE_PRODUCT")?></a>
					</td>
					<?
				}
				unset($arElement);
