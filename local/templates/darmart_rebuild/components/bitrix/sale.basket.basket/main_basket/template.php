...
<!--		</div>-->
	...
	?>
	<div id="basket-root" class="card bx-basket bx-<?=$arParams['TEMPLATE_THEME']?> bx-step-opacity" style="opacity: 0;">
		<div class="row">
			<div class="col">
...
<!--                                <button class="btn" type="button" data-entity="basket-filter-clear-btn">&times;</button>-->
                                <button type="button" data-toggle="tooltip" title="" class="btn" data-entity="basket-filter-clear-btn" data-original-title="Удалить">
