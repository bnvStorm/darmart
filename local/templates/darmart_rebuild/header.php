                ...
                <li>
                    <? $APPLICATION->IncludeComponent(
                        ...
                        array(
                            ...
                            "EDIT_TEMPLATE" => "",
                            "PATH" => "/local/templates/darmart_rebuild/inc/header/top_phone.php"
                        )
                    ); ?>
                <li>
                    <? $APPLICATION->IncludeComponent(
                        ...
                        array(
                            ...
                            "AREA_FILE_SUFFIX" => "inc",
                            "EDIT_TEMPLATE" => "",
                            "PATH" => "/local/templates/darmart_rebuild/inc/header/top_email.php"
                        )
                    ); ?>
                </li>
            </ul>
                    ...
                    <a href="<?= SITE_DIR ?>">
                        <? $APPLICATION->IncludeComponent(
                            ...
                            array(
                                ...
                                "AREA_FILE_SUFFIX" => "inc",
                                "EDIT_TEMPLATE" => "",
                                "PATH" => "/local/templates/darmart_rebuild/inc/header/logo.php"
                            )
                        ); ?>
                    </a>
                </div>
                ...
                <div class="online-help-box">
                    ...
                    <? $APPLICATION->IncludeComponent(
                        ...
                        array(
                            ...
                            "AREA_FILE_SUFFIX" => "inc",
                            "EDIT_TEMPLATE" => "",
                            "PATH" => "/local/templates/darmart_rebuild/inc/header/help_phone.php"
                        )
                    ); ?>
                </div>
            </div>
