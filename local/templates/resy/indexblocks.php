...
<?if(in_array("SERVICES", $arSetting["HOME_PAGE"]["VALUE"])):?>
	...
	array(
		...
		"SERVICES_BLOCK_DESCRIPTION" => "Основными направлениями деятельности ООО «МТК» являются комплексные решения в области технологических смазочных материалов и оборудования для их применения. На протяжении многих лет мы представляем на российском рынке ведущих европейских производителей в названных областях.",
...
<?if(in_array("PROJECTS", $arSetting["HOME_PAGE"]["VALUE"])):?>
	...
	array(
		...
		"PROJECTS_BLOCK_TITLE" => "РЕШЕНИЯ RESY",
