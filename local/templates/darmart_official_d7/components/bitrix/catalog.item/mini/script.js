...
(function (window){
	...
	var BasketButton = function(params)
	{
		...
		this.buttonNode = BX.create('span', {
			props: {className: 'btn main-btn btn-buy btn-sm', id: this.id},
	...
	window.JCCatalogItem.prototype = {
		...
		compareResult: function(result)
		{
			...
			if (result.STATUS === 'OK')
			{
				...
				popupContent = '<div style="width: 100%; margin: 0; text-align: center;"><p style="margin-top: 10px;">'
			...
			else
			{
				...
				if (successful)
				{
					...
					strContent = '<div style="width: 100%; margin: 0; text-align: center;"><img src="'
						+ strPict + '" height="130" style="max-height:130px"><p style="margin-top: 10px;">' + this.product.name + '</p></div>';
