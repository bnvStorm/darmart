    ...
    <div class="card">
        ...
        <form action="<?= POST_FORM_ACTION_URI ?>" method="post" enctype="multipart/form-data">
                    ...
                    <?php foreach ($fieldList as $field): ?>
                        ...
                        ">
                            <?php switch ($field['CODE']):
                                ...
                                <?php default: ?>
                                    <label class="control-label"
                                           for="input-firstname"><?= Loc::getMessage('REGISTER_FIELD_' . $field['CODE']) ?></label>
                                    <input type="text"
            ...
            if ($arResult["USE_CAPTCHA"] == "Y") {
                ?>
                <fieldset>
                    <h2 class="title-page"><b><?= GetMessage("REGISTER_CAPTCHA_TITLE") ?></b></h2>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label class="control-label"
                               for="captcha_word"> <?= GetMessage("REGISTER_CAPTCHA_PROMT") ?>:</label>
