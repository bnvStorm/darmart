<?
$MESS['PAGE_TITLE'] = 'Регистрация';
$MESS['AUTH_MESS'] = 'Если вы уже зарегистрированы, перейдите на страницу <a href="/personal/">авторизации</a>.';
$MESS['MAIN_DATA_TITLE'] = 'Основные данные';
$MESS['ADDRESS_DATA_TITLE'] = 'Ваш адрес';
$MESS['PASSWORD_TITLE'] = 'Ваш пароль';
$MESS['NEWS_TITLE'] = 'Подписка на новости';

$MESS['COUNTRY_KAZAKHSTAN'] = 'Казахстан';

$MESS['SELECT_CHOOSE'] = '--- Выберите ---';
$MESS['SUBSCRIBE'] = 'Подписаться';

$MESS['YES'] = 'Да';
$MESS['NO'] = 'Нет';

$MESS['REGISTERED'] = 'Вы уже зарегестрированы';

$MESS['POLICY_CONFIRMATION'] = 'Мною прочитаны и я даю согласие с документом';
$MESS['POLICY_TITLE'] = 'Политика безопасности';

$MESS["AUTH_REGISTER"] = "Продолжить";
...
$MESS["REGISTER_FIELD_CONFIRM_PASSWORD"] = "Подтвердить";
...
$MESS["REGISTER_FIELD_PERSONAL_STATE"] = "Регион / область";
$MESS["REGISTER_FIELD_PERSONAL_ZIP"] = "Индекс";
$MESS["REGISTER_FIELD_PERSONAL_COUNTRY"] = "Страна";
$MESS["REGISTER_FIELD_PERSONAL_NOTES"] = "Адрес (дополнительно)";
