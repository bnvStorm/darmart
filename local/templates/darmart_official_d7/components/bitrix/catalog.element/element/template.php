    ...
    <div class="bx-catalog-element<?= $themeClass ?>" id="<?= $itemIds['ID'] ?>" itemscope
        ...
        <div class="container-fluid">
            <div class="card">
                <div class="row">
                    <div class="col-md-7">
                        <div class="thumb-container" id="<?= $itemIds['BIG_SLIDER_ID'] ?>">
                            <span class="product-item-detail-slider-close" data-entity="close-popup"></span>
                            <?php if (!empty($actualItem['MORE_PHOTO'])): ?>
                                <div class="slider-thumb-container">

                                    <div class="prev" data-entity="slider-control-left">
                                    ...
                                    <div class="next" data-entity="slider-control-right">
                            ...
                            <div class="slider-bigthumb">
                                ...
                                if (!empty($actualItem['MORE_PHOTO'])) {
                                    foreach ($actualItem['MORE_PHOTO'] as $key => $photo) {
                                        ...
                                        <a data-lightbox="gallery" href="<?= $photo['SRC'] ?>"
                                           title="<?= $title ?>">
                                                        ...
                                                        <div class="form-group required"
                                                            ...
                                                            foreach ($arResult['SKU_PROPS'] as $skuProperty) {
                                                                ...
                                                                <div data-entity="sku-line-block" class="mb-3">
                                                                    <div class="control-label option-label"><?= htmlspecialcharsEx($skuProperty['NAME']) ?></div>
                                                                    <div class="input-option230">
...
//                            ?>
            ...
            <!--Small Card-->
            <div style="display: none;" class="p-2 product-item-detail-short-card-fixed d-none d-md-block"
