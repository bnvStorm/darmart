...
<div class="card card-category">
    <h1 style="margin: 0"><?php $APPLICATION->ShowTitle(false); ?></h1>
</div>
<div class="card">
    <div class="row">
...
<!--	<div id="content" class="pb-4 --><?//=(($isFilter || $isSidebar) ? "col-lg-9 col-md-8 col-sm-7" : "col")?><!--">-->
	<div id="content" class="pb-4 col-sm-9">
		<?
