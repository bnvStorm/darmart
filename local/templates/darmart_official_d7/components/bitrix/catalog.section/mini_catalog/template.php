        ...
        <div class="row">
            <div class="col-md-2 col-sm-6 hidden-xs">
                <div class="btn-group btn-group-sm btn-view">
                    <button type="button" id="list-view" class="btn active" data-toggle="tooltip" title="" data-original-title="Список">
                        <i style="font-size: 14px;" class="fa fa-th-list"></i></button>
                    <button type="button" id="grid-view" class="btn" data-toggle="tooltip" title="" data-original-title="Сетка">
                        <i style="font-size: 14px;" class="fa fa-th"></i></button>
                </div>
            </div>
