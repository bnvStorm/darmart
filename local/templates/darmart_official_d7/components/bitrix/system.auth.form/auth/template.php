...
<? if ($arResult["FORM_TYPE"] == "login"): ?>
    ...
    <form name="system_auth_form<?= $arResult["RND"] ?>" method="post" target="_top"
        ...
        <li><a class="btn-link-drop" href="/personal/register/">Регистрация</a></li>
        <li><a class="btn-link-drop" href="/personal/?login=yes">Авторизация</a></li>
        <li><a class="btn-link-drop" href="/personal/order/make/" title="Оформление заказа">Оформление заказа</a></li>
    </form>
