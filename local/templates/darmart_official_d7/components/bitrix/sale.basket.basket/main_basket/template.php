...
if (empty($arResult['ERROR_MESSAGE'])) {
    ...
    <div id="basket-root" class="card bx-basket bx-<?= $arParams['TEMPLATE_THEME'] ?> bx-step-opacity"
         style="opacity: 0;">
        <div class="row">
            <div class="col">
                ...
                <div class="mb-3 basket-items-list-wrapper basket-items-list-wrapper-height-fixed basket-items-list-wrapper-light<?= $displayModeClass ?>"
                    ...
                    <div class="basket-items-list-header" data-entity="basket-items-list-header">
                        <div class="basket-items-search-field" data-entity="basket-filter">
                            <div class="form input-group">
                                ...
                                <button type="button" data-toggle="tooltip" title="" class="btn"
                                        data-entity="basket-filter-clear-btn" data-original-title="Удалить">
                        ...
                        <div class="basket-items-list-header-filter">
                            <a class="clear_cart" href="<?= $APPLICATION->GetCurPage(); ?>?action=clear" on
                               click="return ClearCart(this);">Очистить корзину</a>
                    ...
                    <div class="basket-items-list-container" id="basket-items-list-container">
                        ...
                        <div class="basket-items-list" id="basket-item-list">
                            ...
                            <table class="main-table" id="basket-item-table"></table>
                        </div>
                    </div>
                </div>
            </div>
